    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="mb-16 font-serif italic text-lg text-[var(--color-text-tertiary)]"
        >
        ...
        <motion.h1
          ...
          className="font-serif text-[clamp(2.5rem,6vw,3.75rem)] leading-[1.08] tracking-tight text-[var(--color-text-primary)]"
        >
